...
export default function DisclaimerPage() {
  return (
    <div className="max-w-[var(--max-w-prose)] mx-auto px-4 sm:px-6 py-14">
      <h1 className="font-serif text-4xl font-bold text-[var(--foreground)] mb-2 text-center">Disclaimer</h1>
      <p className="text-sm text-[var(--text-muted)] mb-10 text-center">Last updated: April 8, 2026</p>
